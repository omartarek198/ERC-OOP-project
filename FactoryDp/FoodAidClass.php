                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="page-header">
                            <h2 >Meal aid request</h2>
                        </div>
                        <p>Please fill this form to apply for our Food aid programme.</p>
                        <form action="CreateController.php" method="post">
                            ...
                            <div class="form-group <?php echo (!empty($phoneno_err)) ? 'has-error' : ''; ?>">
                                ...
                                <input type= "number" name="FamNumber" class="form-control" value="">
                                           <input type= "hidden" name="Income" class="form-control" value="-1">
                                <span class="help-block"></span>
                            </div>
                            ...
                            <div class="form-group <?php echo (!empty($address_err)) ? 'has-error' : ''; ?>">
                              ...
                              <div class="form-group <?php echo (!empty($desc_err)) ? 'has-error' : ''; ?>">
                                ...
                                <textarea value="What qualifies you for this programme " name="desc" class="form-control"></textarea>
                                       <input type= "hidden" name="typeofaid" class="form-control" value="2">
                                <span class="help-block"></span>
                            </div>
                                                        </div>
